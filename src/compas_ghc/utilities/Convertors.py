...
def DisassembleCompasDataStructures(cDtaStruct, bool_ForceDiag = False):
...
def DrawDisassembledCompasDataStructures(_dct_DiasmdDta, bool_ForceDiag=False):
    ...
    if bool_ForceDiag==False:
        ...
        return _rgPtsL_Vertices, _rgLnsL_Edges;
    # draw_mesh(quad_mesh_datastructure, group = False) uv_index


def ConstructRhinocerosMeshFromCompasDataStructure (cDtaStruct):
    _cDtaStruct = cDtaStruct
